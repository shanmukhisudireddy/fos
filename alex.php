    ...
    $.ajax({
        ...
        success:function(resp){
            if(resp==1){
                ...
                setTimeout(function(){
                    location.replace('delivery.php?page=delivery')
                },1500)
            }
        }
    })
...
<?php $amount_paid = $total;
header("Location: insert.php?variable_name=" . urlencode($amount_paid));
exit();
?>
$amount_paid = $_GET['variable_name'];